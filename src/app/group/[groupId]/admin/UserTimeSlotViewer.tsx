...
import type { User, TimeSlot } from '@prisma/client'
...
export function UserTimeSlotViewer({ users, groupId, timeSlots, selectedUserId: initialUserId }: UserTimeSlotViewerProps) {
