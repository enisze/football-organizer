	...
	return (
		<div>
			...
			<p>
				...
				jederzeit widerrufbar. Unser(e) Hoster wird bzw. werden Ihre Daten nur
				...
				Wir setzen folgende(n) Hoster ein: Vercel Inc, 340 S Lemon Ave #4133,
				Walnut, CA 91789, U.S.A. 3. Allgemeine Hinweise und Pflichtinformationen
				...
				VERBINDUNG STEHT. WENN SIE WIDERSPRECHEN, WERDEN IHRE PERSONENBEZOGENEN
				DATEN ANSCHLIESSEND NICHT MEHR ZUM ZWECKE DER DIREKTWERBUNG VERWENDET
				(WIDERSPRUCH NACH ART. 21 ABS. 2 DSGVO). Beschwerderecht bei der
				...
				oder gerichtlicher Rechtsbehelfe. Recht auf Datenübertragbarkeit Sie
				...
				machbar ist. Auskunft, Berichtigung und Löschung Sie haben im Rahmen der
				...
				jederzeit an uns wenden. Recht auf Einschränkung der Verarbeitung Sie
