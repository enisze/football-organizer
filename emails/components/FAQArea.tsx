...
export const FAQArea = () => {
  const texts = [
    ...
    '1.1 Sagst du zu einem Event zu. Erhältst du Erinnerungs-Emails bzgl Bezahlung. Ich bitte dich die Fristen einzuhalten und nur über PayPal zu bezahlen. Der zu zahlende Betrag steht bei jedem Event dabei.',
