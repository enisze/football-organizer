...
export type Event__ReminderEmail = {
  data: {
    user: {
      email: string
      name: string
...
type GeneratedEvents = Readonly<{
  ...
  'user/new': Readonly<User__New>
  'your.event.name': Readonly<Your_Event_Name>
  'stripe/charge.succeeded': Readonly<Stripe__Charge_Succeeded>
  'event/new': Readonly<Event__New>
  'event/reminder': Readonly<Event__Reminder>
