  ...
  return `
      ...
      <mj-column>
       ...
       4. Du kannst in der Applikation zu jedem Event Ort, Datum, Uhrzeit, die Teilnehmer und die Absagen sehen.
        ...
        <mj-text align="left" color="#FFF" font-family="Helvetica" line-height='18px' padding="4px" padding-left="25px" padding-right="25px">
       5. Du kannst unter dem Tab <strong>Deine Events</strong> alle Events sehen zu denen du bereits zu- oder abgesagt hast.
        </mj-text>
       ...
       6. Du kannst in der Applikation deinen aktuellen Kontostand sehen, wenn du oben rechts auf deinen Namen klickst. Dieser wird anhand deiner Aktionen in der Webapp entsprechend berechnet.
        </mj-text>
        </mj-column>
    </mj-section>
    `;
